...
export class DbViewComponent {
  ...
  update(databaseInformation: any) {
    ...
    if (this.databaseInformation.vendorName == 'Neo4j' && this.databaseInformation.databaseName == 'millitant_db') {
      console.log("asd")
      this.nodeData = [
    ...
    } else if (this.databaseInformation.vendorName == 'Neo4j' && this.databaseInformation.databaseName == 'linked_country_test') {
      this.nodeData = [
