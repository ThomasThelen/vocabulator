...
export class ApiService {
  ...
  allProjectsUrl: string = `${this.baseVendorUrl}/project`
  defaultVendorsUrl: string = `${this.baseVendorUrl}/vendor/default`
  currentVendorsUrl: string = `${this.baseVendorUrl}/vendor/current`
  newCurrentVendorUrl: string = `${this.baseVendorUrl}/vendor/current`
